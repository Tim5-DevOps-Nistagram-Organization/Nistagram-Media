...
import rs.ac.uns.ftn.devops.tim5.nistagrammedia.security.AuthenticationTokenFilter;
import rs.ac.uns.ftn.devops.tim5.nistagrammedia.security.CustomAuthProvider;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/actuator/**", "/media/**").permitAll()
